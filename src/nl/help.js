...
var constants_1 = require("../prompts/constants");
/**
 ...
 */
var getHelp = function (prompt) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(prompt === constants_1.HELP)) return [3 /*break*/, 2];
                    return [4 /*yield*/, getHelpList(prompt)];
                case 1:
                    result = _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                    prompt = prompt.replace(constants_1.HELP, '').trim();
                    return [4 /*yield*/, getHelpList(prompt)];
                case 3:
                    result = _a.sent();
                    _a.label = 4;
 ...
 */
var getHelpList = function (prompt) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sql = "SELECT sample_prompt As \"Prompts for ".concat(prompt, "\" FROM help where topic = '").concat(prompt, "' ORDER BY sample_prompt");
