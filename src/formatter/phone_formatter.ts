 ...
 */
const formatPhoneNumber = function (tableData: Array<Array<any>>, numColumns: Array<number>): Array<Array<any>> {
 ...
 * @returns {string} - The formatted phone number.
 */
const formatPhoneNumberFieldUS = function (phoneNumber: string): string {
 ...
 * @returns {string} - The formatted phone number.
 */
const formatPhoneNumberFieldLA = function (phoneNumber: string): string {
  const digitsOnly = phoneNumber.replace(/\D/g, "");
