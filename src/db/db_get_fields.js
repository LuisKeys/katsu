 ...
 */
var getViewFields = function (entityName) {
    return __awaiter(this, void 0, void 0, function () {
        var fields, sql, result, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fields = [];
                    db.connect();
                    sql = "SELECT a.attname FROM pg_class c ";
                    sql += "INNER JOIN pg_attribute a ON a.attrelid = c.oid ";
                    sql += "INNER JOIN pg_type t ON t.oid = a.atttypid ";
                    sql += "WHERE c.relkind = 'v' ";
                    sql += "AND c.relname = '".concat(entityName, "'");
