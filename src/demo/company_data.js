...
function getEmail(firstName, lastName, companyName) {
    var truncatedCompanyName = companyName.substring(0, 10);
    var email = "".concat(firstName.toLowerCase(), ".").concat(lastName.toLowerCase(), "@").concat(truncatedCompanyName.toLowerCase().replace(" ", ""), ".com");
    return email;
}
/**
