...
var fs_1 = require("fs");
var file_name_1 = require("../files/file_name");
var docx_1 = require("docx");
var createWord = function (text) {
    return __awaiter(this, void 0, void 0, function () {
        var fileName, folder, fullPath, doc, url;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fileName = excelFileName();
                    folder = process.env.REPORTS_FOLDER;
                    fullPath = "".concat(folder, "/") + fileName;
                ...
                case 1:
                    _a.sent();
                    url = process.env.REPORTS_URL + fileName;
                    return [2 /*return*/, url];
            }
        });
    });
...
var excelFileName = function () {
    var fileName = (0, file_name_1.randomFileName)('docx');
    return fileName;
};
